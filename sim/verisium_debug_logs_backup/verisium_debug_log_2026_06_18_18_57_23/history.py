...
# history.py generated at 2026/06/18 14:57:23
# host: ece-linlabsrv01
# port: 37321
# launch command: indago -connect dc:ece-linlabsrv01.ece.gatech.edu:50079 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=37321,
        extra_args='-connect dc:ece-linlabsrv01.ece.gatech.edu:50079 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 37321
# Verisium: **************************************************************************************
