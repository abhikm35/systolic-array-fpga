...
# history.py generated at 2026/06/18 10:35:04
# host: ece-linlabsrv01
# port: 34925
# launch command: indago -connect dc:ece-linlabsrv01.ece.gatech.edu:44141 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=34925,
        extra_args='-connect dc:ece-linlabsrv01.ece.gatech.edu:44141 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 34925
# Verisium: **************************************************************************************
