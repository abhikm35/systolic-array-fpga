#!/bin/tcsh -f
#==============================================================================
# run_bram_gui.csh — Verisium GUI for matrix_bram_tb
# Usage: ./run_bram_gui.csh   (from sim/, with DISPLAY set)
...
set log_file = results/logs/matrix_bram_tb_gui.log
...
echo "Launching Verisium GUI: matrix_bram_tb"
echo "Log: ${log_file}"
echo "At xcelium> prompt, type:  run"
echo ""

xrun -64bit -sv -f filelist_bram.f -top matrix_bram_tb \
  -access +rwc -linedebug \
  -input probes_bram.tcl \
