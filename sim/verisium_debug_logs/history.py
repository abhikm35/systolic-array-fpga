...
# history.py generated at 2026/06/18 14:59:22
# host: ece-linlabsrv01
# port: 37563
# launch command: indago -connect dc:ece-linlabsrv01.ece.gatech.edu:51483 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=37563,
        extra_args='-connect dc:ece-linlabsrv01.ece.gatech.edu:51483 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 37563
# Verisium: **************************************************************************************
